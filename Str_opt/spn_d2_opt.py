...
exec(open('/home/avrama/moose/converge.py').read())
test_size=25
...
mean_dict,std_dict,CV=iterate_fit(fit3,test_size,popsiz)
...
mean_dict,std_dict,CV=iterate_fit(fit1,test_size,popsiz)
