...
import params_fitness_chan as pfc
import fit_commands
...
dirname='pfc_'+dataname+'_'+str(seed)+'_'+str(popsiz)
...
fit1=fit_commands.fit_commands(dirname,exp_to_fit,modeltype,ntype,fitness,params1,generations,popsiz, seed)
if test_size>0:
...
save_params.save_params(fit1, startgood, threshold,fn=dirname)
#save_params.persist(fit1,'.')
#results: pretty good, though small ADP, and AHP not quite deep enough
